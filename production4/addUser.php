...
echo ("
 ...
 if ($var_success == 'added') {
   echo("
<div class='row'>
<div class='alert alert-success'><strong>User Added Successfully</strong></div>
</div>
   ");
 };
 ...
 echo("
  <div class='panel-body'>
             <div class='row'>
                 <div class='col-lg-6'>
                 <p class='text-right'><a href='listUser.php'> View Existing User </a></p>
             ...
             <div class='row'>
                 <div class='col-lg-6'>
                         <div class='form-group'>
                             ...
                             <input type='text' name='userUsername' class='form-control' required>
                         </div>
                     </div>
                 </div>
             </div>
               ...
               <div class='col-lg-6'>
                       <div class='form-group'>
                           ...
                           <select name='userAccessLevel' class='form-control'>
							   ...
							   <option selected value=3>ACE</option>
                           </select>
                       </div>
                   </div>
               </div>
