...
if ($clockInID > 0) {
	$sql = "INSERT INTO SHIFT (clockIn, sectionID, serviceLearnerID, shiftComment)
	VALUES ('". $currentTime ."', ". $sectionID .", ". $clockInID .", '". $newComment ."');";
} elseif ($clockOutID > 0) {
	...
	$sql = "UPDATE SHIFT
	SET clockOut = '". $currentTime ."', shiftComment = '". $comment ."'
