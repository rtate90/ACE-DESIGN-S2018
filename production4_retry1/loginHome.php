            ...
            echo("<div class='col-md-4 col-md-offset-4'>
                <div class='login-panel panel panel-default'>
                    <div class='panel-heading'>
                        <img src='images/iulogin.png' width='100%'>
                    </div>
                    ...
                    class='panel-body'>
                        ...
                        <form action='sqlHome.php' method='post'>
                            <fieldset>
								...
								<button type='submit' name='ToDo' value= 'loginServiceLearner.php' class='btn btn-success' style='background-color: #a90000; border: none; margin: 0.5em;'>Clock In/Out</button>
								<button type='submit' name='ToDo' value= 'exportData.php' class='btn btn-primary' style='background-color: #a90000; border: none; margin: 0.5em;'>Export Data</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
