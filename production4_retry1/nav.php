...
<div class='navbar-header'>
 ...
 <a class='navbar-brand'> <p>  &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ACE Time System </p>
 <img src='images/iu-trident.jpg' style='max-width:64px; max-height:50px; margin-top:-45px; margin-left:-15px;'>
					...
					<form method='POST' action='". basename($_SERVER['PHP_SELF']) ."'>");
						if (mysqli_num_rows($resultSemester) > 0) {
							while ($row = mysqli_fetch_assoc($resultSemester)) {
								echo("<input name='semester' type='submit' value='". /*$row["semesterID"] .", ".*/ $row["semesterName"] . "'>". "<br>");
							};
						};
						
					echo("<input name='semester' type='submit' value='0, All Semesters'><br>
					</form>
				</ul>
			</li>");
		};
