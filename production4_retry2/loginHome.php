            ...
            echo("<div class='col-md-4 col-md-offset-4'>
                <div class='login-panel panel panel-default'>
                    <div class='panel-heading'>
                        ...
                        style='text-align: center;'>ACE Time System
						</h1>
                    </div>
                    ...
                    class='panel-body'>
                        <form action='sqlHome.php' method='post'>
                            <fieldset>
								...
								<button type='submit' name='ToDo' value= 'loginServiceLearner.php' class='btn btn-success'>Clock In/Out</button>
								<button type='submit' name='ToDo' value= 'exportData.php' class='btn btn-primary'>Export Data</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
