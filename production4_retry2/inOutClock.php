...
<body>
	<div id='wrapper'>");
		...
		echo("<div id='page-wrapper'>
			<div class='row'>
				<div class='col-lg-12'>
					<h1 class='page-header'>Clock In/Out ". $serviceLearnerUsername ."</h1>
				</div>
			</div>
			<div class='row'>
				<div class='col-md-4 col-md-offset-4'>
					<div class='login-panel panel panel-default'>
						<div class='panel-heading'>
							<h1 class='panel-title' style='text-align: center;'>ACE Clock</h1>
						</div>
						<div style='text-align: center;' class='panel-body'>
							<form action='sqlClock.php' method='post'>
								<fieldset>
									...
									<div class='form-group'>
										<label style='text-align: left;'> Section: </label>
							...
							<a href='inOutMissed.php'><button class='btn btn-warning'>Missed Punch</button></a>

							<br>
							<br>
					

							<a href='https://cas.iu.edu/cas/logout' onclick=\"location.href='http://www.acespring2018.iuserveit.org/production3/loginServiceLearner.php';\" target='_blank'><button class='btn btn-danger'>CAS Logout</button></a>
						</div>
					</div>
				</div>
			</div>
			...
			<h2>Hours Per Section Summary</h2>
				...
				if (mysqli_num_rows($resultShift) > 0) {
					while($row = mysqli_fetch_assoc($resultShift)) {
						echo("<tr>
							...
							<td>". (string)$row["hoursCompleted"] ."</td>
							<td>". (string)$row["hoursNeeded"] ."</td>
						</tr>");
					};
				}; echo("
			</table>
