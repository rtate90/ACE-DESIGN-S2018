...
echo ("
 ...
 if ($var_success == 'added') {
   echo("
<div class='row'>
<div class='alert alert-success'><strong>Course Added Successfully</strong></div>
</div>
   ");
 };
 ...
 echo("
  <div class='panel-body'>
             <div class='row'>
                 <div class='col-lg-6'>
                 <p class='text-right'><a href='courseList.php'> View Existing Courses </a></p>
                   <form action='courseSQL.php' method='post'>
             ...
             <div class='row'>
                 <div class='col-lg-6'>
                         <div class='form-group'>
                             ...
                             <input type='text' name='courseDepartment' class='form-control'>
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class='row'>
                 <div class='col-lg-6'>
                         <div class='form-group'>
                             ...
                             <input type='number_format' name='courseCode' class='form-control' required>
                         </div>
                   </div>
                 </div>
             </div>
